# -*- coding: utf-8 -*-
#
# PKGBUILDer documentation build configuration file, created by
...
copyright = u'2011-2013, Kwpolska'
...
htmlhelp_basename = 'pkgbuilderdoc'
...
MOCK_MODULES = ['pyalpm', 'pycman', 'requests']
