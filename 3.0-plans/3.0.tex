...
\section{Demolition of useless classes}

\begin{tabular}{l|p{20em}}
Priority & \rm1\osn \\
Implementation time & \rm1\osn \\
Depends on & \emph{none}\\
Required by & \begin{itemize}
\item Small fixes and improvements
\item Force \p{--safeupgrade} for \pb
\item Exceptions 2.0
\item The \p{Package} class and its subclasses
\end{itemize}
\end{tabular}

\p{Build}, \p{Upgrade} and \p{Utils} go to hell.

Long story short: \p{v<:\PYZpc{}s/self\PYZbs{}.//g\PY{ckw}{\PYZbs{}n}:\PYZpc{}:\PYZpc{}s/self, //g\PY{ckw}{\PYZbs{}n}:\PYZpc{}s/self)/)/g}.  This is why I love vim.  Add manual checks and reference removals and it is all done.

\section{Small fixes and improvements}
...
Easy to implement, so we will do it quite fast, even though the priority is 10.  Depends on Stage 1 because of \p{\_\_all\_\_}.

\section{Force \p{--safeupgrade} for \pb}
